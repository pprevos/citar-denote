...
If =citar-denote-title-format-authors= is greater than the number of actual authors, all authors will be listed. For example: "Coppa, Hass, Pech and Burger (2008)" when maximum authors greater or equal than 4.
