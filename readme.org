...
1. 
2. Create a new bibliographic note: =citar-create-note=
3. Open existing bibliographic note: =citar-denote-open-note=
4. Open attachments, URLs or other associated notes: =citar-denote-dwim=
5. Open bibliographic entry: =citar-denote-open-reference-entry=
6. Convert existing notes to bibliographic notes: =citar-denote-add-citekey=
7. Removing references from bibliographic notes: =citar-denote-remove-citekey=
   1. Find Denote file citing the current reference(s): =citar-denote-find-reference=
   2. Find a citation in Denote files: =citar-denote-find-citation=
   3. Link to a bibliographic note: =citar-denote-link-reference=
   4. Cite entries not referenced or cited in any note =citar-denote-cite-nocite=
   5. Create a new note for entries not referenced or cited in any note: =citar-denote-reference-nocite=
